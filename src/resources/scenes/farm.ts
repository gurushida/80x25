...
import { SPR_PIG } from "../generated/images/SPR_PIG";
...
const pig: PaintTask = getPaintTask(SPR_PIG, 43, 11, ZIndex.BEHIND_GUY, createMaskHotspot(SPR_PIG, HotspotId.PIG));
